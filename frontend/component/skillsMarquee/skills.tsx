...
const ClientSideSkills = () => {
    ...
    return (
        <>
            <Marquee className="clientSkills p-5 " style={{ width: " 95vw", display: "flex", justifyContent: "space-between" }} speed={200} gradient={false} gradientColor={[37, 8, 121]} gradientWidth={50} pauseOnHover={true} >
